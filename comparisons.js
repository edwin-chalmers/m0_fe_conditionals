...
// YOU DO: Explain.
// The varible `friends` is assigned `6`, and the varible `siblings` is assigned `2`. 
// A log is called to compare if `friends` is greater than `siblins`, which should return `True`.
